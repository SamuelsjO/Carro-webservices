...
public class CarrosAPITest {
	...
	private ResponseEntity<CarroDTO> getCarro(String url){
		return rest.withBasicAuth("soliveira", "123").getForEntity(url, CarroDTO.class);
	}
		
	private ResponseEntity<List<CarroDTO>> getCarros(String url){
		return rest.withBasicAuth("soliveira", "123").exchange(
				url, 
				HttpMethod.GET, 
	...
	public void testSaveCar() {
		...
		assertNotNull(c);
		assertEquals("Posche", c.getNome());
		assertEquals("Esportivos", c.getTipo());
		
		// Deletar o objeto
		rest.withBasicAuth("soliveira", "123").delete(location);
	...
	public void testListaPorTipo() {
		...
		assertEquals(HttpStatus.NO_CONTENT, getCarro("/api/v1/carros/tipo/xxx").getStatusCode());
	}
	...
	public void testGetNotFound() {
		...
		ResponseEntity response = getCarro("/api/v1/carros/classicos/1100");
